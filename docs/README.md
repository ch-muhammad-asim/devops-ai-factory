...
- [`ai-factory/README.md`](ai-factory/README.md) - **start here** for the consolidated plain-English AI Factory guide: AI/LLM concepts, tokens, prompts, temperature vs reasoning effort, context, RAG, embeddings, agents, tools, MCP, gateways, runtimes, quantization, GPUs, Kubernetes, comparison tables, and links to all deeper AI Factory implementation guides.
