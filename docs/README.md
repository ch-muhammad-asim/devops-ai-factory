...
- [`ai-factory/ai-llm-concepts-for-everyone.md`](ai-factory/ai-llm-concepts-for-everyone.md) - start here for a plain-English introduction to AI/LLM concepts, including tokens, temperature, context windows, embeddings, RAG, agents, MCP, gateways, inference runtimes, quantization, GPUs and how the pieces fit together.
